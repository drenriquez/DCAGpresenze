...
async function createFile(){
    ...
    const usersTable= await userDao.getAllUsers()
        ...
        if(tabellaAssenti.length === 0){
            ...
            XLSX.writeFile(wb, `assenze/ASSENZE_DEL_${oggi}_${nameOffice}_.xlsx`);
        ...
        if(tabellaAssenti.length === 0){
           ...
           // var startY = cellPadding;
            ...
            // Salvare il file PDF
            doc.save(`assenze/ASSENZE_DEL_${oggi}_${nameOffice}_.pdf`);
